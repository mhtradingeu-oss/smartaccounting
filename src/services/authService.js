...
const buildToken = (payload) => jwt.sign(payload, JWT_SECRET, { expiresIn: JWT_EXPIRES_IN });
...
const login = async ({ email, password }) => {
  ...
  const token = buildToken({ userId: user.id, role: user.role, companyId: user.companyId });
